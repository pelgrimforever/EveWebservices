 ...
 */
@Path("rsallnodes_stargate_delete")
public class RSAllnodes_stargate_delete extends RS_json_login {
...
//Custom code, do not change this line   
    ...
    private void delete_allnodes_stargate(Allnodes_stargate_usecases allnodes_stargateusecases, JSONObject json) throws ParseException, CustomException {
        ...
        allnodes_stargateusecases.securedeleteAllnodes_stargate(allnodes_stargate);
        setReturnstatus("OK");
    }
}
