...
//add here custom operations
                case IMaterialinputOperation.UPDATE_MATERIALUSAGE:
                    update_materialusage(materialinputusecases, json);
                    break;
//Custom code, do not change this line   
            }
        }
...
//Custom code, do not change this line
//add here custom operations
    private void update_materialusage(Materialinput_usecases materialinputusecases, JSONObject json) throws ParseException, CustomException {
        ...
        materialinputusecases.update_materialusage(username, amount, evetypePK);
        setReturnstatus("OK");
    }
//Custom code, do not change this line   
