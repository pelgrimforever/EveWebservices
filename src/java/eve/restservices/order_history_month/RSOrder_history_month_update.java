 ...
 */
@Path("rsorder_history_month_update")
public class RSOrder_history_month_update extends RS_json_login {
...
//Custom code, do not change this line   
    ...
    private void update_order_history_month(Order_history_month_usecases order_history_monthusecases, JSONObject json) throws ParseException, CustomException {
        ...
        order_history_monthusecases.secureupdateOrder_history_month(order_history_month);
        setReturnstatus("OK");
    }
}
