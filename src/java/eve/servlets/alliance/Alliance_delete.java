 ...
 */
@WebServlet(name="Alliance_delete", urlPatterns={"/eve.Alliance_delete"})
public class Alliance_delete extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case IAllianceOperation.DELETE_ALLIANCE:
                    delete_alliance(allianceusecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
...
//Custom code, do not change this line   
    ...
    private void delete_alliance(Alliance_usecases allianceusecases) throws CustomException {
