 ...
 */
@WebServlet(name="Allnodes_system_update", urlPatterns={"/eve.Allnodes_system_update"})
public class Allnodes_system_update extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case IAllnodes_systemOperation.UPDATE_ALLNODES_SYSTEM:
                    update_allnodes_system(allnodes_systemusecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
