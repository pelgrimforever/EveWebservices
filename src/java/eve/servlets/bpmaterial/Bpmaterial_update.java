 ...
 */
@WebServlet(name="Bpmaterial_update", urlPatterns={"/eve.Bpmaterial_update"})
public class Bpmaterial_update extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case IBpmaterialOperation.UPDATE_BPMATERIAL:
                    update_bpmaterial(bpmaterialusecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
...
//Custom code, do not change this line   
    ...
    private void update_bpmaterial(Bpmaterial_usecases bpmaterialusecases) throws CustomException {
        IBpmaterial bpmaterial = (IBpmaterial)parser.getJavaObject("bpmaterial");
        bpmaterialusecases.secureupdateBpmaterial(bpmaterial);
    }
