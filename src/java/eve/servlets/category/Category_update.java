 ...
 */
@WebServlet(name="Category_update", urlPatterns={"/eve.Category_update"})
public class Category_update extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case ICategoryOperation.UPDATE_CATEGORY:
                    update_category(categoryusecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
...
//Custom code, do not change this line   
    ...
    private void update_category(Category_usecases categoryusecases) throws CustomException {
        ICategory category = (ICategory)parser.getJavaObject("category");
        categoryusecases.secureupdateCategory(category);
    }
