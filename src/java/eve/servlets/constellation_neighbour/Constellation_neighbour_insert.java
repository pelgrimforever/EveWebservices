 ...
 */
@WebServlet(name="Constellation_neighbour_insert", urlPatterns={"/eve.Constellation_neighbour_insert"})
public class Constellation_neighbour_insert extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case IConstellation_neighbourOperation.INSERT_CONSTELLATION_NEIGHBOUR:
                    insert_constellation_neighbour(constellation_neighbourusecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
...
//Custom code, do not change this line   
    ...
    private void insert_constellation_neighbour(Constellation_neighbour_usecases constellation_neighbourusecases) throws CustomException {
        IConstellation_neighbour constellation_neighbour = (IConstellation_neighbour)parser.getJavaObject("constellation_neighbour");
        constellation_neighbourusecases.secureinsertConstellation_neighbour(constellation_neighbour);
    }
