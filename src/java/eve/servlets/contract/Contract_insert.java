 ...
 */
@WebServlet(name="Contract_insert", urlPatterns={"/eve.Contract_insert"})
public class Contract_insert extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case IContractOperation.INSERT_CONTRACT:
                    insert_contract(contractusecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
...
//Custom code, do not change this line   
    ...
    private void insert_contract(Contract_usecases contractusecases) throws CustomException {
        IContract contract = (IContract)parser.getJavaObject("contract");
        contractusecases.secureinsertContract(contract);
    }
