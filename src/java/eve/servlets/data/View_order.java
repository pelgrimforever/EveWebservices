...
import eve.BusinessObject.Logic.BLview_order;
 ...
 */
@WebServlet(name="View_order", urlPatterns={"/eve.View_order"})
public class View_order extends SecurityDataServlet {
                ...
                case DataServlet.OPERATIONTYPE_SELECT:
                    switch(this.operation) {
                        case IView_orderOperation.SELECT_ALL:
                            dataobject = blview_order.getView_orders();
                            break;
                    }
                    break;
            }
