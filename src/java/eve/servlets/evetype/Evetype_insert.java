 ...
 */
@WebServlet(name="Evetype_insert", urlPatterns={"/eve.Evetype_insert"})
public class Evetype_insert extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case IEvetypeOperation.INSERT_EVETYPE:
                    insert_evetype(evetypeusecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
...
//Custom code, do not change this line   
    ...
    private void insert_evetype(Evetype_usecases evetypeusecases) throws CustomException {
        IEvetype evetype = (IEvetype)parser.getJavaObject("evetype");
        evetypeusecases.secureinsertEvetype(evetype);
    }
