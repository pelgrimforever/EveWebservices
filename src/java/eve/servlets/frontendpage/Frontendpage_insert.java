 ...
 */
@WebServlet(name="Frontendpage_insert", urlPatterns={"/eve.Frontendpage_insert"})
public class Frontendpage_insert extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case IFrontendpageOperation.INSERT_FRONTENDPAGE:
                    insert_frontendpage(frontendpageusecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
...
//Custom code, do not change this line   
    ...
    private void insert_frontendpage(Frontendpage_usecases frontendpageusecases) throws CustomException {
        IFrontendpage frontendpage = (IFrontendpage)parser.getJavaObject("frontendpage");
        frontendpageusecases.secureinsertFrontendpage(frontendpage);
    }
