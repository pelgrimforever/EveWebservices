 ...
 */
@WebServlet(name="Frontendpage_auth_update", urlPatterns={"/eve.Frontendpage_auth_update"})
public class Frontendpage_auth_update extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case IFrontendpage_authOperation.UPDATE_FRONTENDPAGE_AUTH:
                    update_frontendpage_auth(frontendpage_authusecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
...
//Custom code, do not change this line   
    ...
    private void update_frontendpage_auth(Frontendpage_auth_usecases frontendpage_authusecases) throws CustomException {
        IFrontendpage_auth frontendpage_auth = (IFrontendpage_auth)parser.getJavaObject("frontendpage_auth");
        frontendpage_authusecases.secureupdateFrontendpage_auth(frontendpage_auth);
    }
