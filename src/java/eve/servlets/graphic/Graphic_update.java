 ...
 */
@WebServlet(name="Graphic_update", urlPatterns={"/eve.Graphic_update"})
public class Graphic_update extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case IGraphicOperation.UPDATE_GRAPHIC:
                    update_graphic(graphicusecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
...
//Custom code, do not change this line   
    ...
    private void update_graphic(Graphic_usecases graphicusecases) throws CustomException {
        IGraphic graphic = (IGraphic)parser.getJavaObject("graphic");
        graphicusecases.secureupdateGraphic(graphic);
    }
