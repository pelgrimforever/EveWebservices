...
@WebServlet(name="Json_orders_delete", urlPatterns={"/eve.Json_orders_delete"})
public class Json_orders_delete extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case IJson_ordersOperation.DELETE_JSON_ORDERS:
                    delete_json_orders(json_ordersusecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
...
//Custom code, do not change this line   
    ...
    private void delete_json_orders(Json_orders_usecases json_ordersusecases) throws CustomException {
