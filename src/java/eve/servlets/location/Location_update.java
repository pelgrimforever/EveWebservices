 ...
 */
@WebServlet(name="Location_update", urlPatterns={"/eve.Location_update"})
public class Location_update extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case ILocationOperation.UPDATE_LOCATION:
                    update_location(locationusecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
...
//Custom code, do not change this line   
    ...
    private void update_location(Location_usecases locationusecases) throws CustomException {
        ILocation location = (ILocation)parser.getJavaObject("location");
        locationusecases.secureupdateLocation(location);
    }
