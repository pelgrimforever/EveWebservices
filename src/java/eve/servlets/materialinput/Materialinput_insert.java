 ...
 */
@WebServlet(name="Materialinput_insert", urlPatterns={"/eve.Materialinput_insert"})
public class Materialinput_insert extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case IMaterialinputOperation.INSERT_MATERIALINPUT:
                    insert_materialinput(materialinputusecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
...
//Custom code, do not change this line   
    ...
    private void insert_materialinput(Materialinput_usecases materialinputusecases) throws CustomException {
