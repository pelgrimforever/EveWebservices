...
@WebServlet(name="Order_history_insert", urlPatterns={"/eve.Order_history_insert"})
public class Order_history_insert extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case IOrder_historyOperation.INSERT_ORDER_HISTORY:
                    insert_order_history(order_historyusecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
