 ...
 */
@WebServlet(name="Order_history_month_insert", urlPatterns={"/eve.Order_history_month_insert"})
public class Order_history_month_insert extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case IOrder_history_monthOperation.INSERT_ORDER_HISTORY_MONTH:
                    insert_order_history_month(order_history_monthusecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
...
//Custom code, do not change this line   
    ...
    private void insert_order_history_month(Order_history_month_usecases order_history_monthusecases) throws CustomException {
        IOrder_history_month order_history_month = (IOrder_history_month)parser.getJavaObject("order_history_month");
        order_history_monthusecases.secureinsertOrder_history_month(order_history_month);
    }
