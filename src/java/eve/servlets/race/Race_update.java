 ...
 */
@WebServlet(name="Race_update", urlPatterns={"/eve.Race_update"})
public class Race_update extends SecurityDataServlet {
...
//Custom code, do not change this line   
    ...
    private void update_race(Race_usecases raceusecases) throws CustomException {
        IRace race = (IRace)parser.getJavaObject("race");
        raceusecases.secureupdateRace(race);
    }
