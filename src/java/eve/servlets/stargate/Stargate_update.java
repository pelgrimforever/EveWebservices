 ...
 */
@WebServlet(name="Stargate_update", urlPatterns={"/eve.Stargate_update"})
public class Stargate_update extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case IStargateOperation.UPDATE_STARGATE:
                    update_stargate(stargateusecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
...
//Custom code, do not change this line   
    ...
    private void update_stargate(Stargate_usecases stargateusecases) throws CustomException {
        IStargate stargate = (IStargate)parser.getJavaObject("stargate");
        stargateusecases.secureupdateStargate(stargate);
    }
