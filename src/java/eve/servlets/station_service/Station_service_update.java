 ...
 */
@WebServlet(name="Station_service_update", urlPatterns={"/eve.Station_service_update"})
public class Station_service_update extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case IStation_serviceOperation.UPDATE_STATION_SERVICE:
                    update_station_service(station_serviceusecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
...
//Custom code, do not change this line   
    ...
    private void update_station_service(Station_service_usecases station_serviceusecases) throws CustomException {
