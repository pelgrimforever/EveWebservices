 ...
 */
@WebServlet(name="Stocktrade_delete", urlPatterns={"/eve.Stocktrade_delete"})
public class Stocktrade_delete extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case IStocktradeOperation.DELETE_STOCKTRADE:
                    delete_stocktrade(stocktradeusecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
...
//Custom code, do not change this line   
    ...
    private void delete_stocktrade(Stocktrade_usecases stocktradeusecases) throws CustomException {
        IStocktrade stocktrade = (IStocktrade)parser.getJavaObject("stocktrade");
        stocktradeusecases.securedeleteStocktrade(stocktrade);
    }
