 ...
 */
@WebServlet(name="Systemjumps_insert", urlPatterns={"/eve.Systemjumps_insert"})
public class Systemjumps_insert extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case ISystemjumpsOperation.INSERT_SYSTEMJUMPS:
                    insert_systemjumps(systemjumpsusecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
...
//Custom code, do not change this line   
    ...
    private void insert_systemjumps(Systemjumps_usecases systemjumpsusecases) throws CustomException {
        ISystemjumps systemjumps = (ISystemjumps)parser.getJavaObject("systemjumps");
        systemjumpsusecases.secureinsertSystemjumps(systemjumps);
    }
