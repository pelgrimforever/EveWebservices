 ...
 */
@WebServlet(name="Trade_delete", urlPatterns={"/eve.Trade_delete"})
public class Trade_delete extends SecurityDataServlet {
...
//Custom code, do not change this line   
    ...
    private void delete_trade(Trade_usecases tradeusecases) throws CustomException {
        ITrade trade = (ITrade)parser.getJavaObject("trade");
        tradeusecases.securedeleteTrade(trade);
    }
