 ...
 */
@WebServlet(name="Tradecombined_sell_update", urlPatterns={"/eve.Tradecombined_sell_update"})
public class Tradecombined_sell_update extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case ITradecombined_sellOperation.UPDATE_TRADECOMBINED_SELL:
                    update_tradecombined_sell(tradecombined_sellusecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
...
//Custom code, do not change this line   
    ...
    private void update_tradecombined_sell(Tradecombined_sell_usecases tradecombined_sellusecases) throws CustomException {
        ITradecombined_sell tradecombined_sell = (ITradecombined_sell)parser.getJavaObject("tradecombined_sell");
        tradecombined_sellusecases.secureupdateTradecombined_sell(tradecombined_sell);
    }
