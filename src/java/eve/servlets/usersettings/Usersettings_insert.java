 ...
 */
@WebServlet(name="Usersettings_insert", urlPatterns={"/eve.Usersettings_insert"})
public class Usersettings_insert extends SecurityDataServlet {
        ...
        try {
            switch(this.operation) {
                case IUsersettingsOperation.INSERT_USERSETTINGS:
                    insert_usersettings(usersettingsusecases);
                    break;
//Custom code, do not change this line
//add here custom operations
//Custom code, do not change this line   
