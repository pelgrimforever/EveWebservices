...
//Custom code, do not change this line   
    ...
    public ArrayList<Allnodes_stargate> search_allnodes_stargate(IAllnodes_stargatesearch allnodes_stargatesearch) throws ParseException, CustomException {
        return blallnodes_stargate.search(allnodes_stargatesearch);
    }
    
    public long search_allnodes_stargate_count(IAllnodes_stargatesearch allnodes_stargatesearch) throws ParseException, CustomException {
