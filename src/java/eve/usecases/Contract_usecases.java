...
//Custom code, do not change this line   
    ...
    public ArrayList<Contract> search_contract(IContractsearch contractsearch) throws ParseException, CustomException {
        return blcontract.search(contractsearch);
    }
    
    public long search_contract_count(IContractsearch contractsearch) throws ParseException, CustomException {
