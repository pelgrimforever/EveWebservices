...
//Custom code, do not change this line   
    ...
    public ArrayList<Eveuser> search_eveuser(IEveusersearch eveusersearch) throws ParseException, CustomException {
        return bleveuser.search(eveusersearch);
    }
    
    public long search_eveuser_count(IEveusersearch eveusersearch) throws ParseException, CustomException {
