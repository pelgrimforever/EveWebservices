...
//Custom code, do not change this line   
    ...
    public ArrayList<Materialinput> search_materialinput(IMaterialinputsearch materialinputsearch) throws ParseException, CustomException {
        return blmaterialinput.search(materialinputsearch);
    }
    
    public long search_materialinput_count(IMaterialinputsearch materialinputsearch) throws ParseException, CustomException {
