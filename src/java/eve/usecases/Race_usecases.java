...
//Custom code, do not change this line   
    ...
    public ArrayList<Race> search_race(IRacesearch racesearch) throws ParseException, CustomException {
        return blrace.search(racesearch);
    }
    
    public long search_race_count(IRacesearch racesearch) throws ParseException, CustomException {
