...
//Custom code, do not change this line   
    ...
    public ArrayList<Shipfit> search_shipfit(IShipfitsearch shipfitsearch) throws ParseException, CustomException {
        return blshipfit.search(shipfitsearch);
    }
    
    public long search_shipfit_count(IShipfitsearch shipfitsearch) throws ParseException, CustomException {
