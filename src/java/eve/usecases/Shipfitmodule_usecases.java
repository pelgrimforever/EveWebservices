...
//Custom code, do not change this line   
    ...
    public ArrayList<Shipfitmodule> search_shipfitmodule(IShipfitmodulesearch shipfitmodulesearch) throws ParseException, CustomException {
        return blshipfitmodule.search(shipfitmodulesearch);
    }
    
    public long search_shipfitmodule_count(IShipfitmodulesearch shipfitmodulesearch) throws ParseException, CustomException {
