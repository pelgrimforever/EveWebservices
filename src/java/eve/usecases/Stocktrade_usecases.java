...
//Custom code, do not change this line   
    ...
    public ArrayList<Stocktrade> search_stocktrade(IStocktradesearch stocktradesearch) throws ParseException, CustomException {
        return blstocktrade.search(stocktradesearch);
    }
    
    public long search_stocktrade_count(IStocktradesearch stocktradesearch) throws ParseException, CustomException {
