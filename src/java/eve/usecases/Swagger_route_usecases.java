...
public class Swagger_route_usecases {
    ...
    public static ArrayList<Long> getRoute_usecase(long origin, long destination, ArrayList<Long> avoidsystems, boolean secure) {
    ...
    private static ArrayList<Long> transform_routeJSON_to_ArrayList(JSONArray jsonroute) {
    ...
    public static ArrayList<Systemkill_data> getSystemkills_usecase() {
    ...
    private static Systemkill_data transform_systemkillsJSON_to_Systemkill_data(JSONObject json) {
    ...
    public static class Systemkill_data {
        long system_id;
        int npc_kills;
        int pod_kills;
        int ship_kills;
    ...
    public static ArrayList<EveGatecheck_data> getGatecheck_for_systems_usecase(ArrayList systems) {
    ...
    public static void validate_and_transform_gatecheckJSON_to_EveGatecheck_data(ArrayList<EveGatecheck_data> evegatechecks, String key, JSONObject jsongatechecks) {
        try {
            Long.valueOf(key);
    ...
    public static EveGatecheck_data transform_gatecheckJSON_to_EveGatecheck_data(String systemid, JSONObject jsongatechecks) {
    ...
    public static class EveGatecheck_data {
        long system_id;
        int killmails;
