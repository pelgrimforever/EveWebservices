...
//Custom code, do not change this line   
    ...
    public ArrayList<Usersettings> search_usersettings(IUsersettingssearch usersettingssearch) throws ParseException, CustomException {
        return blusersettings.search(usersettingssearch);
    }
    
    public long search_usersettings_count(IUsersettingssearch usersettingssearch) throws ParseException, CustomException {
